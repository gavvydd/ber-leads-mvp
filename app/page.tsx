...
export default function HomePage() {
  // IMPORTANT: only create date options after client mounts (prevents SSR/client mismatch)
  const [mounted, setMounted] = useState(false);
  useEffect(() => setMounted(true), []);

  const dateOptions = useMemo(() => (mounted ? makeNextDaysLabels(10) : []), [mounted]);
  ...
  // 🔒 FOCUS LOCK (fixes “one character at a time”)
  ...
  email: emailRef,
    ...
    // keep cursor at end if something stole focus
    const el = r.current;
                ...
                <div style={{ display: "grid", gap: 14 }}>
                  ...
                  <div>
                    ...
                    <input
                      ref={townRef}
                      value={form.town}
                      onFocus={() => (activeFieldRef.current = "town")}
                  ...
                  <div>
                    ...
                    <input
                      ref={eircodeRef}
                      value={form.eircode}
                      onFocus={() => (activeFieldRef.current = "eircode")}
                  ...
                  <div style={{ display: "grid", gap: 12, gridTemplateColumns: "1fr 1fr" }}>
                    <div>
                      ...
                      <input
                        ref={phoneRef}
                        value={form.phone}
                        onFocus={() => (activeFieldRef.current = "phone")}
